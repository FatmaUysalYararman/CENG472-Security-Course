<template>
  <div class="logged">
    <div class="container-fluid header">NURSE PANEL</div>
    <div class="row">
      <div class="col-md-2">
        <sidebar v-bind:loggedType="'nurse'" v-on:changeView="changeView"></sidebar>
      </div>
      <div class="col-md-10">
...
import NurseUserTable from '@/components/nurse/NurseUserTable.vue'
